...
namespace GeckoimagesApi.DriveService
{
    public class DriveUtils
    {
        ...
        public static Google.Apis.Drive.v3.DriveService AuthenticateServiceAccount(string serviceAccountEmail, string serviceAccountCredentialFilePath)
        {
            try
            {
                ...
                string[] scopes = { Google.Apis.Drive.v3.DriveService.Scope.Drive, Google.Apis.Drive.v3.DriveService.Scope.DriveFile }; // View your Google Analytics data
